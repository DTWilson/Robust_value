...
>>>>>>> 5291f30777baca1bc6c2ef24a40fb86fafec7ee7
## Introduction
...
```{r}
get_diff <- function(med1, fixed, lambda)
{
  opt_v <- get_design(med1)[3]
  get_value(fixed, med1, lambda) - opt_v
}

uniroot(get_diff, c(2,8), fixed=c(15, 40), lambda=lambda)

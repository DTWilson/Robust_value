...
# Optimal n at each parameter point [analogous to send plots in 
# running example]
df3 <- df2[,1:2]
df3$v <- apply(df2[,3:ncol(df2)], 1, max)

# Find simple fixed design, i.e. maximising value at the point estimates 
...
df5 <- df2 # Contains values for each point and n
...
# Print minimax regret n and its power
mm_reg_n
1-pt(qt(0.975, 2*(mm_reg_n-1)), 2*(mm_reg_n-1), delta/sqrt(2*sig^2/mm_reg_n))

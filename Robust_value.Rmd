...
This figure shows the indifference contours in each case. Power/precision as a function of $n$ is shown for two possible values of the nuisance parameter $\sigma$ and an MCID of 0.3, and the optimal (value-maximising) sample size is highlighted for each of these specific cases. The pink line denotes the contour below which it becomes optimal to not run the trial at all due to the setup costs.
...
for(i in 1:4){
  ...
  df <- expand.grid(sig = seq(0.1, 3, 0.1),
                    n = 2:500)
  if(i < 3){
    df$v <- v1(n = df$n, sig = df$sig, lambda1 = lambda, c1 = C)
  } else {

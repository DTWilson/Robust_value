...
```{r}
# Set up the specific example point and interval estimate of sigma
sig <- 1; k <- 30
lo <- sqrt(k*sig^2/qchisq(0.975, k)) 
up <- sqrt(k*sig^2/qchisq(0.025, k)) 
...
Strong rationale for this approach - can clearly argue that the value of power at a fixed point is highly dependant on how likely we think that point is. E.g. very low value for power at unrealistically high points, except where meiated through implied power at realistic points (though this will be tending to 1).
